        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-600 mb-6 animate-fade-in">
              Precision-engineered tapered roller bearings designed for the most demanding applications.
            </p>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-white p-6 rounded-lg border border-gray-200 shadow-sm animate-on-scroll">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {(filters.category || filters.application || filters.search) && (
                    <button 
                  ...
                  {filteredProducts.map((product, index) => (
                    <div 
                      ...
                      className={`animate-on-scroll card-hover bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 transition-all duration-300 cursor-pointer ${
                        activeProduct === product.id ? 'ring-2 ring-gbi-700' : ''
                      }`}
              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-8">
                    ...
                    <h2 className="text-2xl font-bold mb-4">{activeProductDetails.name}</h2>
                    <p className="text-gray-600 mb-6">{activeProductDetails.description}</p>
                    ...
                    <div className="grid grid-cols-2 gap-y-4 mb-6">
                      <div>
                        ...
                        <span className="font-medium">{activeProductDetails.specs.innerDiameter}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 text-sm block">Outer Diameter</span>
                        <span className="font-medium">{activeProductDetails.specs.outerDiameter}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 text-sm block">Width</span>
                        <span className="font-medium">{activeProductDetails.specs.width}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 text-sm block">Dynamic Load Rating</span>
                        <span className="font-medium">{activeProductDetails.specs.dynamicLoadRating}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 text-sm block">Static Load Rating</span>
                        <span className="font-medium">{activeProductDetails.specs.staticLoadRating}</span>
                      </div>
                      <div>
                        <span className="text-gray-500 text-sm block">Limit Speed</span>
                        <span className="font-medium">{activeProductDetails.specs.limitSpeed}</span>
                      </div>
                    </div>
      ...
      <section className="py-16 md:py-24 bg-gbi-700 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center animate-on-scroll">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Need a Custom Bearing Solution?</h2>
            <p className="text-xl text-white/80 mb-8">
              Our engineering team can design and manufacture custom bearings tailored to your specific requirements.
            </p>
            <a 
              href="/contact" 
                ...
                <div className="flex gap-3 mt-6">
                  <button 
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        const element = document.getElementById(activeProductDetails.id);
                        if (element) {
                          element.scrollIntoView({ behavior: 'smooth' });
                        }
                      }, 100);
